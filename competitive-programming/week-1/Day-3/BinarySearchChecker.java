...
public class BinarySearchChecker {
    ...
    public static boolean isBinarySearchTree(BinaryTreeNode root) {
        ...
        return isBinarySearchTree(root,minimum,maximum);
    }
    public static boolean isBinarySearchTree(BinaryTreeNode root,int mini,int maxi){
        if(root==null) return true;
        if(root.value<=mini || root.value>maxi) return false;
        return isBinarySearchTree(root.left,mini,root.value) && isBinarySearchTree(root.right,root
        .value,maxi);
    }
